...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.product.id == null ? "base/product/save" : "base/product/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "base/product/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "base/product/info/"+id, function(r){
                vm.product = r.data;
            });
		},
